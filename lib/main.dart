          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(
                  horizontal: 20.0, vertical: 8.0), // Reduced vertical padding
              child: Row(
            ...
            Expanded(
              child: GridView(
                ...
                children: [
                  _buildFoodItemCard('Burger King Hallmarks',
                      'assets/burger_icon.jpeg', '45.000'),
                  _buildFoodItemCard('Double Cheese Burger',
                      'assets/burger_icon.jpeg', '35.000'),
                  _buildFoodItemCard(
                      'Classic Burger', 'assets/burger_icon.jpeg', '25.000'),
                  _buildFoodItemCard(
                      'Chicken Burger', 'assets/burger_icon.jpeg', '30.000'),
                  _buildFoodItemCard('Beef Burger Special',
                      'assets/burger_icon.jpeg', '40.000'),
                  _buildFoodItemCard(
                      'Fish Burger', 'assets/burger_icon.jpeg', '28.000'),
                ],
              ),
            ),
          ],
